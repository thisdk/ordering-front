    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('price')">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="price / 100" :duration="3200" class="card-panel-num" />
        </div>
      </div>
    </el-col>
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('obtain')">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="obtain" :duration="3600" class="card-panel-num" />
        </div>
      </div>
    </el-col>
  </el-row>
